...
для таких полей задаём явные алиасы, равные точному ключу JSON (см. граблям).

См. объектной модели IPS (раздел «Идентичность: объект ≠ версия») и граблям.
