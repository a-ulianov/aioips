...
Имена выводятся из адреса эндпоинта (см. [конвенцию имён](docs/contributing.md)); разрушающие операции защищены гейтом `confirm=True`. Полный плоский список — [docs/reference/all-methods.md](docs/reference/all-methods.md). Разделы свёрнуты:
...
Подробнее об архитектуре — в [документации](docs/architecture.md).
...
Проект не аффилирован с компанией Интермех. Все торговые марки принадлежат их правообладателям.
